        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ request()->routeIs('teacher.notes.app') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('teacher.notes.app') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-book-2" width="24" height="24"
