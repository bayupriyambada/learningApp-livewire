                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                        ...
                        <div class="d-none d-xl-block ps-2">
                            ...
                            <div class="mt-1 small text-muted">Nik. {{ auth()->guard('teacher')->user()->nik }}</div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        <a href="{{ route('teacher.profile') }}"
                            class="dropdown-item {{ request()->routeIs('teacher.profile') ? 'active' : '' }}"">Profile & account</a>
                        <div class=" dropdown-divider">
                    </div>
                    @livewire('teacher.auth.logout')
                </div>
            </div>
        </div>
        </div>
    </header>
    @include('template.pages.teacher.inc.menus')
</div>
